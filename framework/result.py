...
def func_success(data=None, msg='success', **kwargs):
    """
    普通函数成功返回格式
    :param data:
    :param msg:
...
def func_error(data=None, msg='error', **kwargs):
    """
    普通函数失败返回格式
    :param data:
    :param msg:
...
def func_result(result=True, data=None, msg='success', **kwargs):
    """
    普通函数返回格式
    :param result:
    :param data:
    ...
    """
    if result:
        return func_success(data=data, msg=msg)
    return func_error(data=data, msg=msg)
